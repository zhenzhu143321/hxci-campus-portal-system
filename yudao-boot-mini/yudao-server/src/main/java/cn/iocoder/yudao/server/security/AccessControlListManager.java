...
public class AccessControlListManager {
    ...
    private static final Map<String, Set<String>> ROLE_PERMISSIONS = Map.of(
        ...
        "TEACHER", Set.of(
            ...
            "TODO_CREATE_CLASS", "TODO_READ_CLASS", "TODO_READ_ACADEMIC", "TODO_UPDATE_CLASS", "TODO_DELETE_CLASS",
        ...
        "STUDENT", Set.of(
            // 学生 - 基础权限
            "NOTIFICATION_CREATE_PERSONAL", "NOTIFICATION_READ_PERSONAL", "TODO_READ_PERSONAL", "TODO_READ_CLASS", "TODO_UPDATE_PERSONAL", "PROFILE_UPDATE_SELF"
        )
    );
