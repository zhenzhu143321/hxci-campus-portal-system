...
public interface ErrorCodeConstants {
    ...
    // ========== 智能通知系统 1-001-008-000 ==========
    ErrorCode NOTIFICATION_NOT_EXISTS = new ErrorCode(1_001_008_000, "通知不存在");
    ErrorCode NOTIFICATION_STATUS_NOT_DRAFT = new ErrorCode(1_001_008_001, "通知状态不是草稿，无法修改");
    ErrorCode NOTIFICATION_STATUS_NOT_PENDING = new ErrorCode(1_001_008_002, "通知状态不是待审批，无法审批");
    ErrorCode NOTIFICATION_STATUS_NOT_APPROVED = new ErrorCode(1_001_008_003, "通知状态不是已审批，无法发布");
    ErrorCode NOTIFICATION_STATUS_NOT_PUBLISHED = new ErrorCode(1_001_008_004, "通知状态不是已发布，无法推送");
    ErrorCode NOTIFICATION_PERMISSION_DENIED = new ErrorCode(1_001_008_005, "无权限操作该通知");
    ErrorCode NOTIFICATION_LEVEL_INVALID = new ErrorCode(1_001_008_006, "通知级别无效");
    ErrorCode NOTIFICATION_PUSH_CHANNEL_INVALID = new ErrorCode(1_001_008_007, "推送渠道配置无效");
    ErrorCode NOTIFICATION_EXPIRED = new ErrorCode(1_001_008_008, "通知已过期");
    ErrorCode NOTIFICATION_CATEGORY_NOT_EXISTS = new ErrorCode(1_001_008_009, "通知分类不存在");
